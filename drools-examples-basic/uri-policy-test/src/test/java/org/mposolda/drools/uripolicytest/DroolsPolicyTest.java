...
public class DroolsPolicyTest {
    ...
    public static void initDrools() {
        ...
        // Rule specifies that requests to '/droolsTest/foo' are accepted for members of realm roles "role1" and "role2"
        URIPolicyEntry rule1 = URIPolicyEntry.createEntry(8, "/droolsTest/foo", null,
                "\"role1\", \"role2\"", null, null, null, null, null);
        ...
        URIPolicyEntry rule6 = URIPolicyEntry.createEntry(20, "/droolsTest/*", null,
    ...
    public void testPolicy() {
        ...
        RequestInfo request1 = new RequestInfo("/droolsTest/foo");
        // Accepted because of rule1
        Assert.assertEquals(AuthorizationDecision.ACCEPT, droolsPolicy.isRequestAuthorized(request1, john));
        // Rejected because of rule6, which has biggest priority and so it effectively rejects all requests of user with role 'evilRole'
        Assert.assertEquals(AuthorizationDecision.REJECT, droolsPolicy.isRequestAuthorized(request1, evil));

        RequestInfo request2 = new RequestInfo("/droolsTest/foo/bar");
        ...
        RequestInfo request3 = new RequestInfo("/droolsTest/foo/bar");
        ...
        RequestInfo request4 = new RequestInfo("/droolsTest/foo/bar");
        ...
        RequestInfo request5 = new RequestInfo("/droolsTest/foo/bar/baz");
        ...
        RequestInfo request6 = new RequestInfo("/droolsTest/foo/bar/baz");
        ...
        RequestInfo request7 = new RequestInfo("/droolsTest/foo/bar/baz");
        ...
        RequestInfo request8 = new RequestInfo("/droolsTest/john");
        ...
        RequestInfo request9 = new RequestInfo("/droolsTest/mary");
        ...
        RequestInfo request10 = new RequestInfo("/droolsTest/role1");
        ...
        RequestInfo request11 = new RequestInfo("/droolsTest/role2");
        // Ignored.
