...
public class BlogPostDAO {
    ...
    public void likePost(final String permalink, final int ordinal) {
        ...
        BasicDBList list = (BasicDBList)post.get("comments");
        BasicDBObject comment = (BasicDBObject)list.get(ordinal);
        int numLikes = comment.get("num_likes")==null ? 0 : comment.getInt("num_likes");
        numLikes++;
